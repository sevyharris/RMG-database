...
name = "SurfaceThermoFe110"
shortDesc = u"Surface adsorbates on Fe(110)"
longDesc = u"""
Surface species adsorbed on Fe(110).
Thermo is a combination of RMG estimate and DFT calculations from https://doi.org/10.1016/j.susc.2017.09.002
I grabbed the NASA polynomial from RMG's estimate and then shift the enthalpy to match the DFT binding energy
at 298K.
"""
