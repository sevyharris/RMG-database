...
entry(
    ...
    group = 
"""
1   C ux {2,S} {3,[S,D,T,B]}
2   C ux {1,S} {4,[S,D,T,B]}
3 * C u1 r1 {1,[S,D,T,B]}
4   C ux {2,[S,D,T,B]}
5 * H u1
""",
...
entry(
    ...
    group = 
"""
1   C ux {2,[S,D,T,B]} {3,[S,D,T,B]} {6,[S,D,T,B]}
2 * C u1 r1 {1,[S,D,T,B]} {4,[S,D,T,B]}
3   C ux {1,[S,D,T,B]} {5,[S,D,T,B]}
4   C ux {2,[S,D,T,B]} {5,S}
5   C ux {3,[S,D,T,B]} {4,S}
6   C ux {1,[S,D,T,B]}
7 * H u1
""",
    kinetics = None,
...
entry(
    ...
    group = 
"""
1   C u0 r1 {2,S} {3,[S,D,T,B]} {6,[S,D,T,B]}
2 * C u1 r1 {1,S} {4,S}
3   C u0 r1 {1,[S,D,T,B]} {5,B}
4   C u0 r1 {2,S} {5,S}
5   C ux r1 {3,B} {4,S}
6   C ux {1,[S,D,T,B]}
7 * H u1 r0
...
entry(
    ...
    group = 
"""
1   C   ux r1 {3,[S,D,T,B]} {4,S} {7,[S,D,T,B]}
2   C   ux r1 {3,[S,D,T,B]} {5,B} {6,B}
3 * C   u1 r1 {1,[S,D,T,B]} {2,[S,D,T,B]}
4   C   u0 r1 {1,S} {5,[S,D]}
5   C   ux r1 {2,B} {4,[S,D]}
6   C   u0 r1 {2,B}
7   R!H ux {1,[S,D,T,B]}
...
entry(
    ...
    group = 
"""
1   C   ux r1 {2,S} {3,S} {4,[S,D,T,B]}
2   C   ux r1 {1,S} {5,[S,D,T,B]}
3 * C   u1 r1 {1,S}
4   R!H ux {1,[S,D,T,B]}
5   C   ux r1 {2,[S,D,T,B]}
6 * H   u1
...
entry(
    ...
    group = 
"""
1   C ux {2,[B,D]} {3,[S,D,T,B]}
2   C ux {1,[B,D]} {4,[S,D,T,B]}
3 * C u1 r1 {1,[S,D,T,B]}
4   C ux {2,[S,D,T,B]}
5 * H u1
""",
...
entry(
    ...
    group = 
"""
1   C   ux {2,S} {4,[S,D,T,B]} {5,[S,D,T,B]}
2   C   u0 {1,S} {3,D}
3   C   ux {2,D} {6,S}
4   R!H ux {1,[S,D,T,B]}
5   R!H ux {1,[S,D,T,B]}
...
entry(
    ...
    group = 
"""
1   C   ux r1 {2,S} {5,[S,D,T,B]} {6,[S,D,T,B]}
2   C   u0 r1 {1,S} {3,D}
3   C   ux r1 {2,D} {4,S}
4 * C   u1 r1 {3,S} {7,[S,D,T,B]}
5   R!H ux {1,[S,D,T,B]}
6   R!H ux {1,[S,D,T,B]}
7   R!H ux {4,[S,D,T,B]}
8 * H   u1
...
entry(
    ...
    group = 
"""
1   C   ux r1 {2,[B,D]} {3,[S,D,T,B]} {4,[S,D,T,B]}
2   C   ux r1 {1,[B,D]} {5,[S,D,T,B]}
3 * C   u1 r1 {1,[S,D,T,B]}
4   R!H ux {1,[S,D,T,B]}
5   C   ux r1 {2,[S,D,T,B]}
6 * H   u1
...
"""
1   C ux r1 {2,[B,D]} {3,B}
2   C ux r1 {1,[B,D]} {4,[S,D,T,B]}
3 * C u1 r1 {1,B} {6,[S,D,T,B]}
4   C ux r1 {2,[S,D,T,B]} {5,[S,D,T,B]}
5   C ux r1 {4,[S,D,T,B]}
6   C u0 {3,[S,D,T,B]}
7 * H u1
""",
...
entry(
    ...
    group = 
"""
1 * C   u1 r0 {2,S} {3,[S,D,T,B]} {4,S}
2   C   ux r0 {1,S} {6,[S,D,T,B]}
3   C   ux {1,[S,D,T,B]} {5,D}
4   C   u0 r0 {1,S}
5   C   u0 r0 {3,D}
6   R!H ux {2,[S,D,T,B]}
7 * H   u1
...
entry(
    ...
    group = 
"""
1   C u0 r1 {2,D} {3,[S,D,T,B]}
2   C u0 r1 {1,D} {4,S}
3   C ux r1 {1,[S,D,T,B]} {5,S}
4 * C u1 r0 {2,S}
5   C u0 r1 {3,S}
6 * H u1 r0
""",
...
entry(
    ...
    group = 
"""
1 * C   u1 {2,[S,D,T,B]} {4,[S,D,T,B]}
2   C   ux {1,[S,D,T,B]} {3,[S,D,T,B]}
3   R!H ux {2,[S,D,T,B]}
4   R!H ux {1,[S,D,T,B]}
5 * O   u1 {6,[S,D,T,B]}
6   O   ux {5,[S,D,T,B]}
...
entry(
    ...
    group = 
"""
1 * C   u1 {2,[S,D,T,B]} {3,[S,D,T,B]} {4,[S,D,T,B]}
2   C   u0 {1,[S,D,T,B]}
3   R!H ux {1,[S,D,T,B]}
4   R!H ux {1,[S,D,T,B]}
5 * O   u1 {6,S}
...
entry(
    ...
    group = 
"""
1 * C   u1 {3,[S,D,T,B]} {4,[S,D,T,B]} {5,[S,D,T,B]}
2 * C   u1 r0 {6,[S,D,T,B]} {7,[S,D,T,B]}
3   R!H ux {1,[S,D,T,B]}
4   R!H ux {1,[S,D,T,B]}
5   R!H ux {1,[S,D,T,B]}
6   C   ux {2,[S,D,T,B]}
...
entry(
    ...
    group = 
"""
1 * C             u1 r0 {2,[S,D,T,B]} {3,[S,D,T,B]} {4,[S,D,T,B]}
2   R!H           ux {1,[S,D,T,B]}
3   R!H           ux {1,[S,D,T,B]}
4   R!H           ux {1,[S,D,T,B]}
5 * C             u1 r0 {6,[S,D,T,B]}
6   [O,Cl,Si,N,S] u0 r0 {5,[S,D,T,B]}
""",
    kinetics = None,
)
