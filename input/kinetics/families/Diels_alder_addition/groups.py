...
1 *4 Cd u0 r0 {2,S} {3,D}
2 *5 Cd u0 {1,S} {5,D}
3 *3 Cd u0 {1,D} {6,[S,D,T,B,Q]}
4 *1 Cd u0 {7,[D,T]} {8,[S,D,T,B,Q]}
5 *6 Cd u0 {2,D}
6    C  ux {3,[S,D,T,B,Q]}
7 *2 Cd u0 {4,[D,T]}
8    C  ux {4,[S,D,T,B,Q]}
...
entry(
    ...
    group = 
"""
1  *4 Cd  u0 r0 {3,S} {4,D}
2  *1 Cd  u0 {5,D} {6,[S,D,T,B,Q]}
3  *5 Cd  u0 {1,S} {7,D}
4  *3 Cd  u0 {1,D} {8,S}
5  *2 Cd  u0 {2,D} {9,S}
6     C   ux {2,[S,D,T,B,Q]} {10,[S,D,T,B,Q]}
7  *6 Cd  u0 {3,D}
8     C   u0 r0 {4,S}
9     C   u0 r0 {5,S}
...
1 *4 Cd  u0 r0 {2,S} {3,D}
2 *5 Cd  u0 {1,S} {6,D}
3 *3 Cd  u0 {1,D} {8,[S,D,T,B,Q]}
4 *1 Cd  u0 {5,[S,D,T,B,Q]} {7,[D,T]}
5    C   ux {4,[S,D,T,B,Q]} {9,[S,D,T,B,Q]}
6 *6 Cd  u0 {2,D}
7 *2 Cd  u0 {4,[D,T]}
8    C   ux {3,[S,D,T,B,Q]}
...
"""
1 *4 Cd  u0 r0 {2,S} {3,D}
2 *5 Cd  u0 r0 {1,S} {6,D}
3 *3 Cd  u0 r0 {1,D} {8,S}
4 *2 Cd  u0 r0 {5,S} {7,D}
...
entry(
    ...
    group = 
"""
1 *4 Cd u0 r0 {2,S} {4,D}
2 *5 Cd u0 {1,S} {5,D}
3 *1 Cd u0 {6,[D,T]} {7,[S,D,T,B,Q]}
4 *3 Cd u0 {1,D}
5 *6 Cd u0 {2,D}
6 *2 Cd u0 {3,[D,T]}
7    C  ux {3,[S,D,T,B,Q]}
...
entry(
    ...
    group = 
"""
1 *4 Cd u0 r0 {2,S} {5,D}
2 *5 Cd u0 {1,S} {6,D}
3 *1 Cd u0 {4,[D,T]} {7,[S,D,T,B,Q]}
4 *2 Cd u0 {3,[D,T]} {8,S}
5 *3 Cd u0 {1,D}
6 *6 Cd u0 {2,D}
7    C  ux {3,[S,D,T,B,Q]}
...
2 *2 Cd  u0 {1,[D,T]} {8,S}
3    C   ux {1,[S,D,T,B,Q]} {9,[S,D,T,B,Q]}
4 *4 Cd  u0 r0 {5,S} {6,D}
5 *5 Cd  u0 {4,S} {7,D}
6 *3 Cd  u0 {4,D}
7 *6 Cd  u0 {5,D}
8    C   u0 r0 {2,S}
...
entry(
    ...
    group = 
"""
1 *5 Cd  u0 {2,S} {4,D} {5,[S,D,T,B,Q]}
2 *4 Cd  u0 r0 {1,S} {6,D}
3 *1 Cd  u0 {7,[D,T]} {8,[S,D,T,B,Q]}
4 *6 Cd  u0 {1,D}
...
entry(
    ...
    group = 
"""
1 *5 Cd  u0 {2,S} {3,D} {4,[S,D,T,B,Q]}
2 *4 Cd  u0 r0 {1,S} {5,D}
3 *6 Cd  u0 {1,D}
...
entry(
    ...
    group = 
"""
1 *4 Cd  u0 r0 {2,S} {4,D} {5,S}
2 *5 Cd  u0 r0 {1,S} {6,D}
3 *2 Cd  u0 r0 {7,D} {8,[S,D,T,B,Q]}
4 *3 Cd  u0 r0 {1,D}
5    C   u0 r0 {1,S}
6 *6 Cd  u0 r0 {2,D}
7 *1 Cd  u0 r0 {3,D}
