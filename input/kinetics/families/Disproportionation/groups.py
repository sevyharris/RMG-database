...
3    C   u0     r0 {1,S} {7,[S,D,T,B]}
4 *3 C   u[1,2] r0 {1,S}
5 *4 H   u0     r0 {1,S}
6    C   ux     {2,[S,D,T,B]}
7    R!H ux     {3,[S,D,T,B]}
8 *1 O   u1     r0 {9,[S,D,T,B]}
9    O   ux     {8,[S,D,T,B]}
""",
    kinetics = None,
)
...
entry(
    ...
    group = 
"""
1 *2 C   u0 r0 {2,S} {3,S} {4,S} {5,[S,D,T,B]}
2 *3 C   u1 r0 {1,S}
3 *4 H   u0 r0 {1,S}
4    C   u0 r0 {1,S}
5    R!H ux {1,[S,D,T,B]}
...
entry(
    ...
    group = 
"""
1 *2 C   u0 r0 {2,S} {3,S} {4,[S,D,T,B]} {5,[S,D,T,B]}
2 *3 C   u1 r0 {1,S}
3 *4 H   u0 {1,S}
4    R!H ux {1,[S,D,T,B]}
5    R!H ux {1,[S,D,T,B]}
...
entry(
    ...
    group = 
"""
1 *2 C   u0         {3,[S,D,B]} {4,S} {5,[S,D,T,B]} {6,[S,D,T,B]}
2 *1 C   u[1,2,3,4] {7,S} {8,[S,D,T,B]}
3 *3 C   u[1,2]     {1,[S,D,B]}
4 *4 H   u0         {1,S}
5    R!H ux         {1,[S,D,T,B]}
6    R!H ux         {1,[S,D,T,B]}
...
"""
1 *2 C   u0         {3,[S,D,B]} {4,S} {5,[S,D,T,B]} {6,[S,D,T,B]}
2 *1 C   u[1,2,3,4] {7,S} {8,[S,D,T,B]} {9,[S,D,T,B]}
3 *3 C   u[1,2]     {1,[S,D,B]}
4 *4 H   u0         r0 {1,S}
5    R!H ux         {1,[S,D,T,B]}
6    R!H ux         {1,[S,D,T,B]}
...
"""
1 *2 C   u0         {3,[S,D,B]} {4,S} {5,[S,D,T,B]} {6,[S,D,T,B]}
2    C   ux         {7,[S,D,B]} {8,[S,D,T,B]}
3 *3 C   u[1,2]     {1,[S,D,B]}
4 *4 H   u0         {1,S}
5    R!H ux         {1,[S,D,T,B]}
6    R!H ux         {1,[S,D,T,B]}
7 *1 C   u[1,2,3,4] {2,[S,D,B]}
8    R!H ux         {2,[S,D,T,B]}
""",
    kinetics = None,
)
...
entry(
    ...
    group = 
"""
1 *2 C   u0 r0 {3,S} {4,S} {5,D}
2 *1 C   u1 r0 {6,[S,D,T,B]} {7,[S,D,T,B]} {8,[S,D,T,B]}
3 *3 C   u1 r0 {1,S}
4 *4 H   u0 r0 {1,S}
5    C   u0 r0 {1,D}
6    R!H ux {2,[S,D,T,B]}
...
2 *3 C         u1         r0 {1,S} {5,[S,D,T,B]}
3 *4 H         u0         r0 {1,S}
4    C         u0         r0 {1,S}
5    R!H       ux         {2,[S,D,T,B]}
6 *1 [H,C,N,S] u[1,2,3,4] r0 {7,S}
7    S         ux         r0 {6,S}
""",
    kinetics = None,
)
...
4    C                      ux         {1,[S,B]}
5 *1 [H,C,N,S]              u[1,2,3,4] {6,[S,D,T,B]}
6    [I,Br,F,Cl,O,P,C,N,Si] ux         {5,[S,D,T,B]}
""",
    kinetics = None,
)
...
3 *4 H                      u0         {1,S}
4    C                      ux         {1,[S,B]}
5 *1 C                      u[1,2,3,4] {6,[S,D,B]}
6    [I,Br,F,Cl,O,P,C,N,Si] ux         {5,[S,D,B]}
""",
    kinetics = None,
)
...
entry(
    ...
    group = 
"""
1 *2 C   u0         r0 {3,[S,D,B]} {4,S} {5,[S,B]}
2 *1 C   u[1,2,3,4] {6,[S,D,B]} {7,[S,D,T,B]}
3 *3 R!H u[1,2]     {1,[S,D,B]}
4 *4 H   u0         {1,S}
5    C   ux         {1,[S,B]}
6    C   ux         {2,[S,D,B]}
7    R!H ux         {2,[S,D,T,B]}
...
"""
1 *2 C   u0         r0 {3,S} {4,S} {5,S}
2 *1 C   u[1,2,3,4] r0 {6,[S,D,B]} {7,[S,D,T,B]} {8,[S,D,T,B]}
3 *3 C   u1         r0 {1,S}
4 *4 H   u0         r0 {1,S}
5    C   u0         r0 {1,S}
6    C   ux         r0 {2,[S,D,B]}
...
entry(
    ...
    group = 
"""
1 *2 C   u0     r0 {5,[S,D,B]} {6,S} {7,[S,B]}
2 *1 C   u1     {3,S} {4,S}
3    C   u0     {2,S} {9,[S,D,T,B]}
4    C   u0     r0 {2,S} {8,D}
5 *3 S   u[1,2] {1,[S,D,B]}
6 *4 H   u0     {1,S}
7    C   ux     {1,[S,B]}
...
entry(
    ...
    group = 
"""
1 *1 C   u1 {3,S} {4,[S,D,T,B]} {5,[S,D,T,B]}
2 *2 O   u0 {6,S} {7,S}
3    C   u0 r0 {1,S}
4    R!H ux {1,[S,D,T,B]}
5    R!H ux {1,[S,D,T,B]}
...
entry(
    ...
    group = 
"""
1 *1 C   u1     r0 {3,S} {4,[S,D,T,B]} {5,[S,D,T,B]}
2 *2 C   u0     r0 {6,S} {7,S}
3    C   ux     {1,S}
4    R!H ux     {1,[S,D,T,B]}
5    R!H ux     {1,[S,D,T,B]}
